        ...
        { text: 'Cancel', style: 'cancel' },
        {
          ...
          onPress: async () => {
            ...
            try {
              ...
              Alert.alert('Coming soon', 'Account deletion will be available after API integration.');
            } finally {
              setWorking(false);
            }
          },
      ...
      <View style={styles.content}>
        <View style={styles.card}>
          ...
          <Text style={styles.subtitle}>
            This action is permanent. Your order history and saved data will be removed once this feature is enabled.
          </Text>
...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 16, fontWeight: 'bold', color: COLORS.error, marginBottom: 8 },
  subtitle: { fontSize: 13, color: COLORS.textLight, lineHeight: 18, marginBottom: 14 },
