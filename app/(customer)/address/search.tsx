...
export default function AddressSearchScreen() {
  ...
  const [showMenuForAddress, setShowMenuForAddress] = useState<string | null>(
    null,
  );
  ...
  const performSearch = async (text: string) => {
    ...
    try {
      ...
      setSearchResults(
        filtered.map((addr) => ({ ...addr, isSearchResult: false })),
      );
    } finally {
      setIsSearching(false);
    }
  ...
  return (
    <View style={[styles.container, { paddingTop: insets.top }]}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>{t("enterYourArea")}</Text>
      </View>
        ...
        >
          <View style={styles.menuContainer}>
            ...
            <TouchableOpacity
              ...
              onPress={async () => {
                if (showMenuForAddress) {
                  Alert.alert(t("deleteAddress"), t("confirmDeleteAddress"), [
                    {
                      text: "Cancel",
                      style: "cancel",
                      onPress: () => setShowMenuForAddress(null),
                    },
                    {
                      ...
                      onPress: async () => {
                        ...
                        const currentSelected =
                          await addressStorage.getSelectedAddressId();
