...
import { acceptOrder, getAssignedOrders, rejectOrder, toggleStatus, updateDeliveryStatus } from '../../src/services/staff.service';
      ...
      if (order.status === 'pending' && !order.assignedStaffId) {
        setAvailableOrders(prev => {
          ...
          const transformedOrder = {
            ...order,
            id: order._id,
            customer: order.customerId?.name || order.customer?.name || 'Customer',
        ...
        try {
          ...
          if (status === 'granted') {
            try {
              ...
              console.warn('Location unavailable, continuing without location:', locError.message);
          ...
          console.warn('Location permission request failed, continuing without location:', permError.message);
        }
      }
