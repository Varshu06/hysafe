...
import { customerRecurringBillRouter, recurringBillRouter } from './routes/recurringBill.routes';
import recurringDeliveryRoutes from './routes/recurringDelivery.routes';
...
app.use('/api/customers/recurring-bills', customerRecurringBillRouter);
app.use('/api/customers', customerRoutes);
app.use('/api/inventory', inventoryRoutes);
app.use('/api/recurring-bills', recurringBillRouter);
app.use('/api/recurring-deliveries', recurringDeliveryRoutes);
